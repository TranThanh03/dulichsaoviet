...
public class OrderService {
    ...
    public com.websitesaoviet.WebsiteSaoViet.dto.response.OrderResponse createOrder (
        ...
        order.setGuideName(assignment.getGuideName());
    ...
    public List<com.websitesaoviet.WebsiteSaoViet.dto.response.OrderResponse> getOrders() {
        return orderMapper.toListOrdersResponse(orderRepository.findAll());
    }

    public Page<com.websitesaoviet.WebsiteSaoViet.dto.response.admin.OrderResponse> getAllOrders(Pageable pageable) {
        return orderRepository.getAllOrders(pageable);
    }

    public List<OrderResponse> getOrdersByUserId(String id) {
        return orderRepository.findOrderListByUserId(id);
    }

    public com.websitesaoviet.WebsiteSaoViet.dto.response.OrderResponse getOrderById(String id) {
    ...
    public void cancelOrder(String id) {
        ...
        if(assignment != null) {
            assignmentService.minusNumberOfPeople(assignment.getAnotherId(), assignment.getNumberOfPeople());
        }
        else {
