                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        <div class="banner-inner pt-15 pb-25">
                            <h2 class="page-title mb-10 aos-init aos-animate" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">destination</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center mb-20 aos-init aos-animate" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1500" data-aos-offset="50">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-xl-6 col-lg-7">
                            <div class="tour-header-content mb-15" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                                <span class="location d-inline-block mb-10"><i class="fal fa-map-marker-alt"></i>$destination</span>
                        ...
                        <div class="col-xl-4 col-lg-5 text-lg-end" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                            <div class="tour-header-social mb-10">
                                <Link to="#"><i class="far fa-share-alt"></i>Share tours</Link>
                                <Link to="#"><i class="fas fa-heart bgc-secondary"></i>Wish list</Link>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                                    ...
                                    <div class="col-md-6">
                                        <div class="tour-include-exclude mt-30">
                                            ...
                                            <ul class="list-style-one check mt-25">
                                                ...
                                                <li><i class="far fa-check"></i> Một bữa ăn mỗi ngày</li>
                                                <li><i class="far fa-check"></i> Vé máy bay/vé tàu/vé tham quan (nếu có)</li>
                                                <li><i class="far fa-check"></i> Nước đóng chai trên xe buýt</li>
                                                <li><i class="far fa-check"></i> Hướng dẫn viên du lịch</li>
                                                <li><i class="far fa-check"></i> Bảo hiểm du lịch</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="tour-include-exclude mt-30">
                                            ...
                                            <ul class="list-style-one mt-25">
                                                <li><i class="far fa-times"></i> Chi phí ăn uống, tham quan ngoài chương trình</li>
                                                <li><i class="far fa-times"></i> Đón và trả khách tại khách sạn</li>
                                                <li><i class="far fa-times"></i> Chi phí làm hộ chiếu, visa (nếu có)</li>
                                                <li><i class="far fa-times"></i> Thuế VAT</li>
                                                <li><i class="far fa-times"></i> Tiền tip cho hướng dẫn viên, tài xế</li>
                            ...
                            <form id="comment-form" class="comment-form bgc-lighter z-1 rel mt-30 {{ $checkDisplay }}" name="review-form" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                                ...
                                <div class="widget widget-booking" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                                    ...
                                    <form>
                                        ...
                                        <ul class="tickets clearfix">
                                            <li>
                                                Người lớn <span
                                                    class="price">$priceAdult VND
                                                </span>
                                            </li>
                                            <li>
                                                Trẻ em <span
                                                    class="price">priceChild VND
                                                </span>
                                            </li>
                                        </ul>
